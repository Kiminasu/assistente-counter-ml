    ...
    return (
        <div className="flex flex-col gap-6 animated-entry">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                {/* Ally Team */}
                <div className="lg:col-span-3 flex flex-col gap-3 glassmorphism p-4 rounded-xl border-2 panel-glow-blue">
                ...
                <div className="lg:col-span-6 flex flex-col gap-4">
                     <div className="flex justify-center">
                        <button
                            ...
                            className="flex items-center gap-2 bg-gray-800 hover:bg-red-900/50 text-gray-300 hover:text-red-300 font-semibold py-2 px-4 rounded-lg transition-colors duration-200 border border-gray-700 hover:border-red-700 text-sm"
                        >
                ...
                {/* Enemy Team */}
                <div className="lg:col-span-3 flex flex-col gap-3 glassmorphism p-4 rounded-xl border-2 panel-glow-red">
