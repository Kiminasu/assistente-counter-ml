    ...
    return (
        <div className="flex flex-col gap-6 animated-entry">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Ally Team */}
                <div className="lg:col-span-1 flex flex-col gap-3 glassmorphism p-4 rounded-2xl border-2 panel-glow-blue">
                ...
                {/* Enemy Team */}
                <div className="lg:col-span-1 flex flex-col gap-3 glassmorphism p-4 rounded-2xl border-2 panel-glow-red">
