    ...
    return (
        <div className="flex flex-col gap-6 animated-entry">
            ...
            <div className="grid grid-cols-2 gap-4">
                {/* Ally Team */}
                <div className="flex flex-col gap-3 glassmorphism p-4 rounded-xl border-2 panel-glow-blue">
                ...
                {/* Enemy Team */}
                <div className="flex flex-col gap-3 glassmorphism p-4 rounded-xl border-2 panel-glow-red">
