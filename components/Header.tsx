...
const Header: React.FC<HeaderProps> = ({ activeMode, onSetMode }) => {
    ...
    return (
        <header className="text-center mb-8 animated-entry">
            <img src="https://i.postimg.cc/ZK4nFyHG/mitica-logo-Photoroom.png" alt="Mítica Estratégia MLBB Logo" className="h-72 sm:h-[27rem] mx-auto -mt-8 sm:-mt-12 animated-logo" />
            <h1 className="text-6xl sm:text-8xl font-black tracking-tight title-main -mt-16 sm:-mt-24 relative animated-logo">
