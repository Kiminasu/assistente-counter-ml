                    ...
                    <div className="animated-border-glow rounded-2xl">
                        <div className="login-panel-solid p-8 rounded-[14px] relative">
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-1">
                                        <input
                                            ...
                                            required
                                            minLength={6}
                                            className="block w-full bg-slate-800/50 border border-slate-700 rounded-md shadow-sm py-2 px-3 pr-10 text-white focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm"
                                            placeholder="••••••••"
                                        />
                                        <button
                                            type="button"
                            ...
                            <p className="mt-6 text-center text-sm">
                                <button onClick={() => { setIsLogin(!isLogin); setError(null); setMessage(null); }} className="font-medium text-sky-400 hover:text-sky-300">
