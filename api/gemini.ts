...
const heroStrategicAnalysisSchema = { type: Type.OBJECT, properties: { strategy: heroStrategySchema, tacticalCounters: { type: Type.ARRAY, items: tacticalCounterSchema } }, required: ["strategy", "tacticalCounters"] };
