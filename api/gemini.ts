...
// FIX: Added schema for perfect counter hero suggestion.
...
const heroStrategicAnalysisSchema = { type: Type.OBJECT, properties: { strategy: heroStrategySchema, tacticalCounters: { type: Type.ARRAY, items: tacticalCounterSchema }, perfectCounter: heroSuggestionForAISchema }, required: ["strategy", "tacticalCounters", "perfectCounter"] };
